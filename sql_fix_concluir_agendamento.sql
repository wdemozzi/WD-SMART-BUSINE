-- Recria a função concluir_agendamento_com_pagamento
...
declare
  ...
  v_descricao text;
begin
  -- Pega os dados do agendamento + serviço
  select
    a.empresa_id,
    a.cliente_id,
    a.funcionario_id,
  ...
  into
    ...
    v_servico_nome, v_servico_valor
  from agendamentos a
  ...
  -- Gera comissão se tiver funcionário
